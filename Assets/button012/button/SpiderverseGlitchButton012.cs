...
public class SpiderverseGlitchButton012 : MonoBehaviour
{
    [Header("基础设置")]
    ...
    private void Update()
    {
        ...
        // 使用 unscaledDeltaTime 替代 deltaTime，忽略时间缩放
        _timer += Time.unscaledDeltaTime;
        _glitchTimer1 += Time.unscaledDeltaTime * 5f;
        _glitchTimer2 += Time.unscaledDeltaTime * 4f;
